...
2.  В случае успеха, откроется **дополнительное окно-оверлей** (поверх всех других окон) с удобным интерфейсом для копирования названий и цен. В нём также можно указать наценку, НДС и другие параметры.
