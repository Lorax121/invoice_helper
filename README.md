(на 02.08.2025 репозиторий пока не готов к использованию, в течении недели мб приведу его в порядок)
# Invoice Helper
...
6.  Скачайте готовый или соберите самостоятельно `parser.exe` (прикреплю позже).
...
9.  Готово! Запускайте собранный `invoice_helper.exe` (по умолчанию из папки `build\windows\runner\Release`).
